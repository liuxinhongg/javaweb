...
<html>
	...
	<body>
				...
				<table class="layui-table">
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="text" id="moduleId" class="layui-input modeCode" lay-verify="required|id" placeholder="只能输入数字字母下划线">
							</td>
							<td>模块类型</td>
							<td>
						...
						<tr>
							...
							<td>
								<select name="setion modetype"  id="parentId">
		...
		<script src="${pageContext.request.contextPath}/static/js/system/add_menu.js" type="text/javascript" charset="utf-8"></script>
	</body>
