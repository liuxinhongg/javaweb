...
<html>
	...
	<body class="childrenBody">
			...
			<table class="layui-table">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input id="loginId" type="text" class="layui-input Usernum" lay-verify="required|id" placeholder="请输入用户ID">
						</td>
					</tr>
					<tr>
						...
						<td align="right">用户密码<span style="color: #f00;">*</span></td>
						<td>
							<input type="password" id="password" class="layui-input userpassword" lay-verify="required" placeholder="请输入用户密码">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3" id="isAdmin">
							...
							<input type="radio" value="N" name="isAdmin" class="subPage" title="否" checked>
						</td>
					</tr>
					<tr>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/system/add_user.js"></script>
	</body>
