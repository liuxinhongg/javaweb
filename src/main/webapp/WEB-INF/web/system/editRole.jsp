...
<html>
	...
	<body class="childrenBody">
			...
			<table class="layui-table">
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td>
					<input type="tel" id="roleId" class="layui-input roleid layui-disabled" lay-verify="required|id" disabled />
			      </td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			      ...
			      <td align="left">
			      <button class="layui-btn" lay-submit="" lay-filter="updateRoleLinks" lay-verify="errorcodeverify">提交</button>
			      </td>
			    </tr>
			  </tbody>
			</table>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/system/edit_role.js"></script>
