...
<body class="childrenBody">
			...
			<input type="hidden" id="oldUpId" name="oldUpId" value="${branchPo.noId}">
			<table class="layui-table">
				...
				<tbody>
					<tr>
						...
						<td>
							<input type="text" id="branchName" name="branchName" value="${branchPo.branchName}" class="layui-input Usernum" lay-verify="required" placeholder="某某分部" maxlength="20">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<input type="text" id="effectMonth" name="effectMonth" class="layui-input masterPart" value="${branchPo.effectMonthView}" placeholder="请输入任命时间" lay-verify="required|date" onclick="layui.laydate({elem: this,min: laydate.now(),format: 'YYYY-MM'})">
						</td>
					</tr>
					<tr>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/org/editBranch.js"></script>
</body>
</html>