...
<body class="childrenBody">
			...
			<table class="layui-table">
				...
				<tbody>
				    <tr>
						...
						<td>
							<input type="radio" name="branchCity" title="昆明" value="0" class="layui-input Usernum" checked="true" lay-verify="required">
					...
					<tr>
						...
						<td>
							<input type="text" name="branchName" id="branchName" class="layui-input Usernum" lay-verify="required" placeholder="某某分部" maxlength="20">
						</td>
					</tr>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/org/addorg.js"></script>
</body>
</html>