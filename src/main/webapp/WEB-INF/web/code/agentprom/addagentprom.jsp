...
<body class="childrenBody">
				...
				<tbody>
					<tr>
					 ...
					 <tr>
						...
						<td>
							<input type="text" id="highValueMin" name="highValueMin" style="width: 10%;"/>
							≤X<
							<input type="text" id="highValueMax" name="highValueMax" style="width: 10%;"/>
                    ...
                    <tr>
						...
						<td colspan="2">
							<input type="text" id="conditionOrd" name="conditionOrd" class="layui-input Usernum" lay-verify="required" style="display:inline;width:40%">
						</td>
					</tr>
					<tr>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/code/addagentprom.js"></script>
</body>
</html>