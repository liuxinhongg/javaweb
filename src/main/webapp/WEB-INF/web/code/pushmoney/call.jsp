	...
	<body>
		<div class="layui-tab" style="width: 95%;margin: 30px auto;">
			<ul class="layui-tab-title">
				<li style="width: 15%;color: #999;font-size: 16px;font-weight: bold;"><a href="javascript:open();">一次性提成标准</a></li>
				<li class="layui-this" style="width: 15%;color: #999;font-size: 16px;font-weight: bold;">话费提成标准</li>
			</ul>
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					...
					<div class="layui-form links_list">
						...
						<p style="color: #f00;">*
							<a style="color: #f00;">以上含下限，不含上限</a>
						</p>
						<p style="color: #f00;">*
							<a style="color: #f00;">个人每月完成 2笔业务</a>
						</p>
					</div>
					<div id="page"></div>
					...
					<div class="layui-form links_list">
						<table class="layui-table">
							...
							<tbody class="links_content content2">
		...
		<script src="${pageContext.request.contextPath}/static/js/code/call.js" type="text/javascript" charset="utf-8"></script>
	</body>
