...
<body class="childrenBody">
				...
				<tbody>
					<tr>
						...
						<td>
						    ...
						    <input type="text" id="commMax" name="commMax" class="layui-input Usernum" lay-verify="required" placeholder="" style="display:inline;width:90px;">（包含）元
						</td>
					</tr>
                   <tr>
						<td align="right">首年提成比例(%)<span style="color: #f00;">*</span></td>
						<td>
							<input type="text" id="firstYRate" name="firstYRate" class="layui-input Usernum" lay-verify="required" style="display:inline;width:220px;">%
						</td>
					</tr>
					<tr>
						<td align="right">次年提成比例(%)<span style="color: #f00;">*</span></td>
						<td>
							<input type="text" id="secondYRate" name="secondYRate" class="layui-input Usernum" lay-verify="required" style="display:inline;width:220px;">%
						</td>
					</tr>
                    <tr>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/code/addCommCall.js"></script>
</body>
</html>