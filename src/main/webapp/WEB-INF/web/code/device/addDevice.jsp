...
<body class="childrenBody">
			...
			<table class="layui-table">
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input type="text" id="deviceName" name="deviceName" required  maxlength="50" class="layui-input Usernum" lay-verify="required" placeholder="请输入终端名称">
						</td>
					</tr>
                    <tr>
                    ...
                    <tr>
						...
						<td>
							<input type="text" id="deduct" name="deduct" class="layui-input Usernum" required lay-verify="required" placeholder="请输入提成">
						</td>
                        <td align="right">单价<span style="color: #f00;">*</span></td>
						<td>
							<input type="text" id="price" name="price" class="layui-input Usernum" required lay-verify="required" placeholder="请输入单价">
						</td>
					</tr>
                    <tr>
                    ...
                    <tr>
						...
						<td colspan="3">
							<textarea id="deviceDesc" name="deviceDesc" class="layui-textarea linksDesc"></textarea>
						</td>
					</tr>
					<tr>	
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/code/addDevice.js"></script>
</body>
</html>