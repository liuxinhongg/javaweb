...
<body class="childrenBody">
	        <div class="recordhead">
				<strong>岗位津贴标准：</strong>
				<a class="layui-btn linksAdd_btn" style="background-color:#5FB878" href="javascript:add();">添加</a>
			</div>
	...
	<script src="${pageContext.request.contextPath}/static/js/code/position.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>