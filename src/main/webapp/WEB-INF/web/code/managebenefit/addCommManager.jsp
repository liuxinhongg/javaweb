...
<body class="childrenBody">
				...
				<tbody>
					<tr>
						...
						<td>
						    ...
						    <input type="text" id="commMax" name="commMax" class="layui-input Usernum" lay-verify="required" placeholder="" style="display:inline;width:90px;">元
						</td>
					</tr>
                    <tr>
						<td align="right">提成比例<span style="color: #f00;">*</span></td>
						<td>
							<input type="text" id="commRate" name="commRate" class="layui-input Usernum" lay-verify="required" style="display:inline;width:210px;">%
						</td>
					</tr>
					<tr>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/code/addmanagebenefit.js"></script>
</body>
</html>