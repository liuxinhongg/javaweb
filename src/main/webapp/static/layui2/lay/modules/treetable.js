...
layui.define("jquery", function(e) {
    ...
    var o = layui.jquery,
        ...
        i.prototype.traverseModel = function(treeTable, parentNode, item, childrenAttrs) {
            ...
            tableHeaderStr += (i.checkbox == false ? '' : '<th style="width:10px"><input type="checkbox" name="checked" lay-skin="primary" lay-filter="allChoose"></th>');
            ...
            layui.each(n, function(a, n) {
                ...
                var l = n.children && n.children.length > 0,
                    str = o(['<tr class="' + (p ? "layui-hide layui-anim layui-anim-fadein" : "layui-anim layui-anim-fadein") + '" id="' + n.id + '">', 
                        function() {
                            if (i.checkbox){
                                return '<td><input type="checkbox" name="checked" lay-skin="primary" lay-filter="*" value="' + n.id + '" ' + ((n.checked && n.checked == true) ? 'checked="checked"' : "") +'></td>';
                            }
                        }(), 
                        function() {
                            var ret = ""
